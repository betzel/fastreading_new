      ...
      type: function (type) {
        ...
        switch (type) {
          ...
          case 'number':
            ...
            break;
          case 'phone':
            // assert = new Validator.Assert().Regexp('^((8|0|((\\+|00)\\d{1,2}))[\\- ]?)?(\\(?\\d{3}\\)?[\\- ]?)?[\\d\\- ]{7,10}$');
            assert = new Validator.Assert().Regexp('^((8|0|((\\+|00)\\d{1,2}))[\\- ]?)?(\\(?\\d{3}\\)?[\\- ]?)?[\\d\\- ]{7,10}$');
            break;
          case 'integer':
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    email:        "Введите действующий E-mail",//"This value should be a valid email.",
    url:          "This value should be a valid url.",
    number:       "This value should be a valid number.",
    integer:      "This value should be a valid integer.",
    digits:       "This value should be digits.",
    phone:        "Используйте цифры и символы: '+', '-', '(', ')'",//"This value should be phone number.",
    alphanum:     "This value should be alphanumeric."
  },
  notblank:       "This value should not be blank.",
  required:       "Заполните это поле!",//"This value is required.",
  pattern:        "Номер телефона введен неверно",//"This value seems to be invalid.",
  min:            "This value should be greater than or equal to %s.",
  max:            "This value should be lower than or equal to %s.",
  range:          "This value should be between %s and %s.",
  minlength:      "Минимум %s символов",//"This value is too short. It should have %s characters or more.",
